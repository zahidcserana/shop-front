(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/animations'), require('rxjs/internal/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ng-keyboard-shortcuts', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/animations', 'rxjs/internal/operators', '@angular/common'], factory) :
    (global = global || self, factory(global['ng-keyboard-shortcuts'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.animations, global.rxjs['internal/operators'], global.ng.common));
}(this, function (exports, core, rxjs, operators, animations, operators$1, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var KeyboardShortcutsService = /** @class */ (function () {
        ...
        function KeyboardShortcutsService() {
             ...
             */
            this.disabled = false;
            this._shortcutsSub = new rxjs.BehaviorSubject([]);
            this.shortcuts$ = this._shortcutsSub
                .asObservable()
                .pipe(operators.filter(function (shortcuts) { return !!shortcuts.length; }));
             ...
             * @ignore
             */
            this.keydownCombo$ = this.keydown$.pipe(operators.filter(function (_) { return !_this.disabled; }), operators.map(this.mapEvent), operators.filter(function (shortcut) {
                return !shortcut.target || shortcut.event.target === shortcut.target;
            }), operators.filter(function (shortcut) { return isFunction(shortcut.command); }), operators.filter(this.isAllowed), operators.tap(function (shortcut) { return !shortcut.preventDefault || shortcut.event.preventDefault(); }), operators.throttle(function (shortcut) { return rxjs.timer(shortcut.throttleTime); }), operators.tap(function (shortcut) { return shortcut.command({ event: shortcut.event, key: shortcut.key }); }), operators.tap(function (shortcut) { return _this._pressed.next({ event: shortcut.event, key: shortcut.key }); }), operators.catchError(function (error) { return rxjs.throwError(error); }));
            /**
             * @ignore
             */
            this.timer$ = new rxjs.Subject();
            /**
             * @ignore
             */
            this.resetCounter$ = this.timer$
                .asObservable()
                .pipe(operators.switchMap(function () { return rxjs.timer(KeyboardShortcutsService_1.TIMEOUT_SEQUENCE); }));
            /**
             * @ignore
             */
            this.keydownSequence$ = this.shortcuts$.pipe(operators.map(function (shortcuts) { return shortcuts.filter(function (shortcut) { return shortcut.isSequence; }); }), operators.switchMap(function (sequences) {
                return _this.keydown$.pipe(operators.map(function (event) {
                    return {
                        event: event,
                        sequences: sequences
                    };
                }), operators.tap(_this.timer$));
            }), operators.scan(function (acc, arg) {
                var event = arg.event;
                ...
                return { events: __spread(acc.events, [event]), command: result, sequences: result };
            }, { events: [], sequences: [] }), operators.switchMap(function (_a) {
                ...
                if (Array.isArray(command)) {
                     ...
                     */
                    return rxjs.timer(500).pipe(operators.map(function () { return ({ command: command.filter(function (command) { return command.fullMatch; })[0] }); }));
                }
                return rxjs.of({ command: command });
                ...
                var command = _a.command;
                return command;
            }), operators.filter(function (shortcut) { return isFunction(shortcut.command); }), operators.filter(this.isAllowed), operators.tap(function (shortcut) { return !shortcut.preventDefault || shortcut.event.preventDefault(); }), operators.throttle(function (shortcut) { return rxjs.timer(shortcut.throttleTime); }), operators.tap(function (shortcut) { return shortcut.command({ event: shortcut.event, key: shortcut.key }); }), operators.tap(function (shortcut) { return _this._pressed.next({ event: shortcut.event, key: shortcut.key }); }), operators.takeUntil(this.resetCounter$), operators.repeat());
            /**
             * @ignore
        ...
        KeyboardShortcutsService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function KeyboardShortcutsService_Factory() { return new KeyboardShortcutsService(); }, token: KeyboardShortcutsService, providedIn: "root" });
    ...
    var KeyboardShortcutsHelpService = /** @class */ (function () {
        ...
        function KeyboardShortcutsHelpService(keyboard) {
             ...
             * @type {Observable<any>}
             */
            this.shortcuts$ = this.keyboard.shortcuts$.pipe(operators.map(function (shortcuts) {
                return shortcuts
        ...
        KeyboardShortcutsHelpService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function KeyboardShortcutsHelpService_Factory() { return new KeyboardShortcutsHelpService(core.ɵɵinject(KeyboardShortcutsService)); }, token: KeyboardShortcutsHelpService, providedIn: "root" });
    ...
    })(exports.AllowIn || (exports.AllowIn = {}));
    ...
    var KeyboardShortcutsDirective = /** @class */ (function () {
        ...
        KeyboardShortcutsDirective.prototype.transformInput = function (shortcuts) {
            var _this = this;
            return shortcuts.map(function (shortcut) { return (__assign({}, shortcut, { target: _this.el.nativeElement, allowIn: [exports.AllowIn.Select, exports.AllowIn.Input, exports.AllowIn.Textarea] })); });
        };
        /**
         * @ignore
         */
        ...
        KeyboardShortcutsDirective = __decorate([
            ...
            __metadata("design:paramtypes", [KeyboardShortcutsService, core.ElementRef])
    ...
    var KeyboardShortcutsHelpComponent = /** @class */ (function () {
        ...
        KeyboardShortcutsHelpComponent.prototype.ngOnInit = function () {
            ...
            this.subscription = this.keyboardHelp.shortcuts$
                .pipe(operators.distinctUntilChanged(), operators$1.map(function (shortcuts) { return groupBy(shortcuts, "label"); }))
                ...
                animations: [
                    animations.trigger("enterAnimation", [
                        animations.transition(":enter", [
                            ...
                            animations.animate("0.33s cubic-bezier(0,0,0.3,1)", animations.style({ transform: "translateX(0)", opacity: 1 }))
                        ]),
                        animations.transition(":leave", [
                            animations.style({ transform: "translateX(0)", opacity: 1 }),
                            animations.animate("0.23s cubic-bezier(0,0,0.3,1)", animations.style({ transform: "translateX(-100%)", opacity: 0 }))
                        ])
                    ]),
                    animations.trigger("overlayAnimation", [
                        animations.transition(":enter", [
                            animations.style({ opacity: 0 }),
                            animations.animate("1s cubic-bezier(0,0,0.3,1)", animations.style({ opacity: 1 }))
                        ]),
                        animations.transition(":leave", [
                            animations.style({ opacity: 1 }),
                            animations.animate("1s cubic-bezier(0,0,0.3,1)", animations.style({ opacity: 0 }))
                        ])
                    ])
                ],
    ...
    exports.KeyboardShortcutsComponent = KeyboardShortcutsComponent;
    exports.KeyboardShortcutsDirective = KeyboardShortcutsDirective;
    exports.KeyboardShortcutsHelpComponent = KeyboardShortcutsHelpComponent;
    exports.KeyboardShortcutsHelpService = KeyboardShortcutsHelpService;
    exports.KeyboardShortcutsModule = KeyboardShortcutsModule;
    exports.ɵa = KeyboardShortcutsService;
    exports.ɵb = KeyboardShortcutsHelpItemComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ng-keyboard-shortcuts.umd.js.map
